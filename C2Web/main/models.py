...
class Configuracao(models.Model):
    ...
    dschaveapi = models.CharField(verbose_name='Chave da API', max_length=40, null=True, blank=True)
...
class Empresa(models.Model):
    ...
    dsinscricaoestadual = models.CharField(verbose_name='Inscrição estadual', max_length=30, null=True, blank=True)
    dtcadastro = models.DateField()
    dtalteracao = models.DateField()
    dtexclusao = models.DateField(null=True, blank=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE)
...
class EmpresaEndereco(models.Model):
    ...
    dscep = models.CharField(verbose_name='Cep', max_length=8, null=True, blank=True)
    dsbairro = models.CharField(verbose_name='Endereço', max_length=50, null=True, blank=True)
    dscidade = models.CharField(verbose_name='Endereço', max_length=50, null=True, blank=True)
    dsUF = models.CharField(verbose_name='Estado', max_length=2, choices=UF_LIST, null=True, blank=True)
...
class Produto(models.Model):
    nrcodigobarras = models.CharField(verbose_name='Código de barras', max_length=18, null=True, blank=True)
    cdreferencia = models.CharField(verbose_name='Código de referência', max_length=15, null=True, blank=True)
    dsdescricao = models.CharField(verbose_name='Descrição', max_length=100)
    vlprecovenda = models.FloatField(verbose_name='Preço de venda', null=True, blank=True)
    vlprecocusto = models.FloatField(verbose_name='Preço de custo', null=True, blank=True)
    vlmargem = models.FloatField(verbose_name='Margem de lucro', null=True, blank=True)
...
class EstoqueMovimento(models.Model):    
    ...
    saldo = models.FloatField(verbose_name='Saldo atual')
...
class PessoaEndereco(models.Model):
    dsendereco = models.CharField(verbose_name='Endereço', max_length=100)
    dscidade = models.CharField(verbose_name='Cidade', max_length=100, null=True, blank=True)
    dsuf = models.CharField(verbose_name='Estado', max_length=2, choices=UF_LIST)
    dstelefone = models.CharField(verbose_name='Telefone', max_length=12, null=True, blank=True)
    dscelular = models.CharField(verbose_name='Telefone', max_length=12, null=True, blank=True)
    dscep = models.CharField(verbose_name='Telefone', max_length=8, null=True, blank=True)
    dsbairro = models.CharField(verbose_name='Telefone', max_length=50, null=True, blank=True)
...
class OrdemServico(models.Model):    
    ...
    dtpromessa = models.DateField(verbose_name='Prometido para', null=True, blank=True)
    valorlimite = models.FloatField(verbose_name='Fazer até no valor de', null=True, blank=True)
...
class OrdemServicoEquipamento(models.Model):
    ...
    nrserie = models.CharField(verbose_name='Número de série', max_length=50, null=True, blank=True)
    dsmarca = models.CharField(verbose_name='Marca', max_length=50, null=True, blank=True)
